...
if ( ! defined( 'GWANGI_THE_EVENTS_CALENDAR_TITLE' ) ) {
	define( 'GWANGI_THE_EVENTS_CALENDAR_TITLE', esc_html__( 'Calendario de Eventos', 'gwangi' ) );
}

if ( ! defined( 'GWANGI_THE_EVENTS_CALENDAR_DESCRIPTION' ) ) {
	define( 'GWANGI_THE_EVENTS_CALENDAR_DESCRIPTION', esc_html__( '¡Participa de los proximos evetos Culturales!', 'gwangi' ) );
}
