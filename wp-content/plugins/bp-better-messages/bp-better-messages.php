...
if ( !class_exists( 'BP_Better_Messages' ) && !function_exists( 'bpbm_fs' ) ) {
    class BP_Better_Messages
    {
        ...
        public function load_scripts()
        {
            ...
            wp_register_script( 'emojionearea_js', plugins_url( 'assets/js/emojionearea.js', __FILE__ ), $this->version );
            wp_register_script( 'taggle_js', plugins_url( 'assets/js/taggle.min.js', __FILE__ ), $this->version );
            wp_register_script( 'scrollbar_js', plugins_url( 'assets/js/jquery.scrollbar.min.js', __FILE__ ), $this->version );
            wp_register_script( 'amaran_js', plugins_url( 'assets/js/jquery.amaran.js', __FILE__ ), $this->version );
