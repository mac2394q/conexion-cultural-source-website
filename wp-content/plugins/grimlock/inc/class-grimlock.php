...
class Grimlock {
	...
	public function add_page_templates( $page_templates ) {
		$page_templates = array_merge( $page_templates, $this->get_page_templates() );
	...
	public function get_page_template_path( $template ) {
		...
		$new_template = $this->locate_template( $page_template );
	...
	public function enqueue_block_editor_assets() {
		...
		wp_enqueue_script( 'grimlock-blocks', GRIMLOCK_PLUGIN_DIR_URL . 'assets/js/block/build/blocks.js', array_merge( $asset_file['dependencies'], array( 'wp-edit-post' ) ), GRIMLOCK_VERSION, true );
	}
