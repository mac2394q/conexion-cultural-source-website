...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/block/src/query-section-block.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./assets/js/block/src/block/QuerySectionBlock.js":
/*!********************************************************!*\
  !*** ./assets/js/block/src/block/QuerySectionBlock.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return QuerySectionBlock; });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _SectionBlock__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SectionBlock */ "./assets/js/block/src/block/SectionBlock.js");
...
var _GrimlockQuerySection = GrimlockQuerySectionBlock,
    POST_TYPES = _GrimlockQuerySection.POST_TYPES,
    TAXONOMIES = _GrimlockQuerySection.TAXONOMIES;
var _GrimlockSectionBlock = GrimlockSectionBlock,
    GRIMLOCK_PLUGIN_DIR_URL = _GrimlockSectionBlock.GRIMLOCK_PLUGIN_DIR_URL;

var QuerySectionBlock = /*#__PURE__*/function (_SectionBlock) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(QuerySectionBlock, _SectionBlock);

  var _super = _createSuper(QuerySectionBlock);

  function QuerySectionBlock() {
    var _this;

    var blockType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'query-section';
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, QuerySectionBlock);

    blockArgs = _objectSpread({
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Grimlock Query Section', 'grimlock'),
      icon: 'align-right',
      category: 'widgets',
      keywords: [Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('query section', 'grimlock')],
      supports: {
        html: false,
        align: ['wide', 'full']
      }
    }, blockArgs);
    _this = _super.call(this, blockType, blockDomain, blockArgs);
    /**
     * General Panel
     */

    wp.hooks.removeFilter("".concat(_this.blockBaseId, "_block_general_panel"), "".concat(_this.blockBaseId, "_add_thumbnail_field"));
    wp.hooks.removeFilter("".concat(_this.blockBaseId, "_block_general_panel"), "".concat(_this.blockBaseId, "_add_separator_20_field"));
    wp.hooks.removeFilter("".concat(_this.blockBaseId, "_block_general_panel"), "".concat(_this.blockBaseId, "_add_text_field"));
    wp.hooks.removeFilter("".concat(_this.blockBaseId, "_block_general_panel"), "".concat(_this.blockBaseId, "_add_wpautoped_field"));
    /**
     * Query Panel
     */

    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_post_type_field"), _this.addPostTypeField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 10);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_taxonomies_field"), _this.addTaxonomiesField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 20);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_meta_key_field"), _this.addMetaKeyField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 30);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_meta_compare_field"), _this.addMetaCompareField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 40);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_meta_value_field"), _this.addMetaValueField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 50);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_meta_value_num_field"), _this.addMetaValueNumField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 60);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_posts_per_page_field"), _this.addPostsPerPageField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 70);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_orderby_field"), _this.addOrderbyField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 80);
    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_query_panel"), "".concat(_this.blockBaseId, "_add_order_field"), _this.addOrderField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 90);
    /**
     * Layout Panel
     */

    wp.hooks.addFilter("".concat(_this.blockBaseId, "_block_layout_panel"), "".concat(_this.blockBaseId, "_add_posts_layout_field"), _this.addPostsLayoutField.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3___default()(_this)), 9);
    /**
     * Style Panel
     */

    wp.hooks.removeFilter("".concat(_this.blockBaseId, "_block_style_panel"), "".concat(_this.blockBaseId, "_add_text_color_field"));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(QuerySectionBlock, [{
    key: "registerBlockPanels",
    value: function registerBlockPanels(panels) {
      return _objectSpread(_objectSpread({}, panels), {}, {
        general: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('General', 'grimlock'),
        query: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Query', 'grimlock'),
        layout: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Layout', 'grimlock'),
        style: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Style', 'grimlock')
      });
    }
  }, {
    key: "addPostTypeField",
    value: function addPostTypeField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["SelectControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Post Type', 'grimlock'),
        value: attributes.post_type,
        onChange: function onChange(post_type) {
    ...
    key: "addTaxonomiesField",
    value: function addTaxonomiesField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_component_SelectControlWithOptGroup__WEBPACK_IMPORTED_MODULE_11__["default"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Taxonomies', 'grimlock'),
        value: attributes.taxonomies,
        onChange: function onChange(taxonomies) {
          return setAttributes({
    ...
    key: "addMetaKeyField",
    value: function addMetaKeyField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["TextControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Meta Key', 'grimlock'),
        value: attributes.meta_key || '',
        onChange: function onChange(meta_key) {
          return setAttributes({
            meta_key: meta_key
          });
        }
    ...
    key: "addMetaCompareField",
    value: function addMetaCompareField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["SelectControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Meta Compare', 'grimlock'),
        value: attributes.meta_compare,
        onChange: function onChange(meta_compare) {
          return setAttributes({
    ...
    key: "addMetaValueField",
    value: function addMetaValueField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["TextControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Meta Value', 'grimlock'),
        value: attributes.meta_value || '',
        onChange: function onChange(meta_value) {
          return setAttributes({
    ...
    key: "addMetaValueNumField",
    value: function addMetaValueNumField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["ToggleControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Treat meta value as a number', 'grimlock'),
        checked: !!attributes.meta_value_num,
        onChange: function onChange(meta_value_num) {
          return setAttributes({
    ...
    key: "addPostsPerPageField",
    value: function addPostsPerPageField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["__experimentalNumberControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Number of posts to display', 'grimlock'),
        value: attributes.posts_per_page,
        onChange: function onChange(posts_per_page) {
          return setAttributes({
    ...
    key: "addOrderbyField",
    value: function addOrderbyField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["SelectControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Order by', 'grimlock'),
        ...
        options: [{
          value: 'none',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('No order', 'grimlock')
        }, {
          value: 'ID',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('ID', 'grimlock')
        }, {
          value: 'author',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Author', 'grimlock')
        }, {
          value: 'title',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Title', 'grimlock')
        }, {
          value: 'name',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Slug', 'grimlock')
        }, {
          value: 'type',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Post type', 'grimlock')
        }, {
          value: 'date',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Creation date', 'grimlock')
        }, {
          value: 'modified',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Last modified date', 'grimlock')
        }, {
          value: 'parent',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Post/Page parent ID', 'grimlock')
        }, {
          value: 'rand',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Random order', 'grimlock')
        }, {
          value: 'comment_count',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Number of comments', 'grimlock')
        }, {
          value: 'relevance',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Relevance (the ones matching the search best first)', 'grimlock')
        }, {
          value: 'menu_order',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Menu order', 'grimlock')
        }]
      }));
      return fields;
    }
    ...
    key: "addOrderField",
    value: function addOrderField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["SelectControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Order', 'grimlock'),
        ...
        options: [{
          value: 'ASC',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Ascending', 'grimlock')
        }, {
          value: 'DESC',
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Descending', 'grimlock')
        }]
      }));
      return fields;
    }
  }, {
    key: "addPostsLayoutField",
    value: function addPostsLayoutField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["RadioControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('Layout', 'grimlock'),
        selected: attributes.posts_layout || '',
        onChange: function onChange(posts_layout) {
          return setAttributes({
            posts_layout: posts_layout
          });
        },
        options: [{
          value: '12-cols-classic',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-12-cols-classic.png',
            alt: "12-cols-classic"
          })
        }, {
          value: '6-6-cols-classic',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-6-6-cols-classic.png',
            alt: "6-6-cols-classic"
          })
        }, {
          value: '4-4-4-cols-classic',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-4-4-4-cols-classic.png',
            alt: "4-4-4-cols-classic"
          })
        }, {
          value: '3-3-3-3-cols-classic',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-3-3-3-3-cols-classic.png',
            alt: "3-3-3-3-cols-classic"
          })
        }, {
          value: '6-6-cols-lateral',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-6-6-cols-lateral.png',
            alt: "6-6-cols-lateral"
          })
        }, {
          value: '12-cols-lateral',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/posts-12-cols-lateral.png',
            alt: "12-cols-lateral"
          })
        }],
    ...
    value: function addLayoutField(fields, attributes, setAttributes) {
      fields.push(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["RadioControl"], {
        ...
        options: [{
          value: '12-cols-center-left',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/section-alignment-12-cols-center-left.png',
            alt: "12-cols-left"
          })
        }, {
          value: '12-cols-center',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/section-alignment-12-cols-center.png',
            alt: "12-cols-center"
          })
        }, {
          value: '12-cols-left',
          label: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])("img", {
            src: GRIMLOCK_PLUGIN_DIR_URL + 'assets/images/section-alignment-12-cols-left.png',
            alt: "12-cols-right"
          })
        }],
        className: "grimlock-radio-image"
  ...
  return QuerySectionBlock;
}(_SectionBlock__WEBPACK_IMPORTED_MODULE_10__["default"]);
...
/***/ "./assets/js/block/src/query-section-block.js":
/*!****************************************************!*\
  !*** ./assets/js/block/src/query-section-block.js ***!
  \****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _block_QuerySectionBlock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block/QuerySectionBlock */ "./assets/js/block/src/block/QuerySectionBlock.js");
 // Init Query Section Block

new _block_QuerySectionBlock__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/******/ });
//# sourceMappingURL=query-section-block.js.map