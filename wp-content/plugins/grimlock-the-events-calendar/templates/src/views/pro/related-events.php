					...
					<div class="card h-100">
						...
						<div class="card-body tribe-events-event-details tribe-clearfix">
							<div class="card-body-header">
								<h2 class="card-body-title h4"><a href="<?php echo tribe_get_event_link( $post ); ?>" class="tribe-event-url" rel="bookmark"><?php echo get_the_title( $post->ID ); ?></a></h2>
								<div class="card-body-meta mb-0">
