		...
		<div class="card p-3 mb-4">
			...
			<div class="d-flex mb-2 align-items-center">
				<div class="mr-3">
					...
					<?php else : ?>
						<img class="img-fluid rounded-circle d-inline-block" width="80" height="80" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/avatars/user-avatar-thumb.png' ); ?>" alt=" <?php esc_html_e( 'avatar', 'the-events-calendar' ); ?>" />
					<?php endif; ?>
				</div>
				<div>
					<!-- Organizer Title -->
