						...
						<div class="tribe-events-single-header">
							...
							<div class="tribe-events-single-header-meta">
								...
								<h1 class="tribe-events-single-header-title">
									<?php the_title(); ?><?php if ( tribe_get_cost() ) : ?><span class="tribe-events-cost"><?php echo tribe_get_cost( null, true ); ?></span><?php endif; ?>
								...
								<?php echo tribe_get_event_categories(
									get_the_id(), array(
										...
										'label_after'  => '</span>',
										'wrap_before'  => '<div class="tribe-events-single-categories">',
										'wrap_after'   => '</div>',
									)
								); ?>
