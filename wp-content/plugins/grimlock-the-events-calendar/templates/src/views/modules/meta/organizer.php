				...
				<div class="m-0 p-3 text-center">
					...
					<div class="tribe-organizer-img mb-2">
						<a href="<?php echo esc_url( get_the_permalink( $organizer ) ); ?>">
							...
							<?php else : ?>
								<img class="img-fluid rounded-circle d-inline-block" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/avatars/user-avatar-thumb.png' ); ?>" alt="<?php esc_html_e( 'avatar', 'the-events-calendar' ); ?>" />
							<?php endif; ?>
						</a>
