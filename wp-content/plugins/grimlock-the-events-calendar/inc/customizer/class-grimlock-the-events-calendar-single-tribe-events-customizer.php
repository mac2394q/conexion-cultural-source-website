<?php
/**
 * Grimlock_The_Events_Calendar_Single_Events_Customizer Class
 *
 * @author  Themosaurus
 * @since   1.0.0
 * @package grimlock
 ...
 */
class Grimlock_The_Events_Calendar_Single_Events_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	/**
	 * Check if template is the template for the single tribe_events page.
	 *
	 * @since 1.0.0
	 *
	...
	public function is_template( $default = false ) {
		return is_singular( 'tribe_events' ) || $default;
	}
}

return new Grimlock_The_Events_Calendar_Single_Events_Customizer();
