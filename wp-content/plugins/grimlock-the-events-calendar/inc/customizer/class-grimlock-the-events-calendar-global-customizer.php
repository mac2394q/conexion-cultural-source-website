<?php
/**
 * Grimlock_The_Events_Calendar_Global_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Grimlock_The_Events_Calendar_Global_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
...
return new Grimlock_The_Events_Calendar_Global_Customizer();
