 ...
 */
class Grimlock_The_Events_Calendar_Single_Tribe_Organizer_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	/**
	 * Check if template is the template for the single tribe_organizer page.
	 *
	 * @since 1.0.0
	 *
	...
	public function is_template( $default = false ) {
		return is_singular( 'tribe_organizer' ) || $default;
	}
}
